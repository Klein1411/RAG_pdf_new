...
Chạy với: pytest test_gemini_client.py -v
"""
...
class TestGeminiClientInitialization:
    ...
    def test_init_with_multiple_keys(self, mock_model, mock_configure):
    ...
    @patch('gemini_client.genai.configure')
    @patch('gemini_client.genai.GenerativeModel')
    def test_init_with_custom_model_name(self, mock_model, mock_configure):
        """Test khởi tạo với tên model tùy chỉnh"""
...
class TestKeyRotation:
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY_1": "key_1"})
    @patch('gemini_client.genai.configure')
    @patch('gemini_client.genai.GenerativeModel')
...
class TestGenerateContent:
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY_1": "test_key"})
    @patch('gemini_client.genai.configure')
    @patch('gemini_client.genai.GenerativeModel')
    ...
    @patch.dict(os.environ, {"GEMINI_API_KEY_1": "invalid_key"})
    @patch('gemini_client.genai.configure')
    @patch('gemini_client.genai.GenerativeModel')
    def test_generate_content_raises_on_all_keys_fail(self, mock_model_class, mock_configure):
        ...
        with pytest.raises(ConnectionError, match="không hợp lệ"):
